...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $precio = mysqli_real_escape_string($conn, $_POST['total']);
    $productos = json_decode($_POST['productos'], true);

    // Insertar pedido
    $sqlPedido = "INSERT INTO pedidos (id_usuario, fecha_pedido, estado,total) VALUES ('$id_usuario', NOW(), 'Pendiente',$precio)";
    if ($conn->query($sqlPedido)) {
        ...
        foreach ($productos as $prod) {
            ...
            $conn->query("INSERT INTO detalle_pedidos (id_pedido, id_producto, cantidad, precio_unitario) VALUES ($id_pedido, $id_producto, 1, $precio)");
...
<body>
    ...
    function cargarCarritoPago() {
      ...
      `;
      // Pasar productos al formulario para el backend
